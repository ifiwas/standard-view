...
// -----   Animations   -----//
// --------------------------//
export function spin({ mesh, state }: { mesh: any; state: any }): void {
  // Default State
...
export function spinZ({ mesh, state }: { mesh: any; state: any }): void {
  // Default State
  state.r = state.r == null ? 0 : state.r;
  state.speed = state.speed == null ? 1 : state.speed;
...
export function spinY({ mesh, state }: { mesh: any; state: any }): void {
  // Default State
  state.r = state.r == null ? 0 : state.r;
  state.speed = state.speed == null ? 1 : state.speed;
...
export function Balls(props: any): React.ReactElement {
  const r = 3;
